...
This package is the essential, non-optional foundation of PixelPatrol. It provides the API, CLI, Pixel Patrol processing, and the plugin system that allows other packages (like pixel-patrol-loader-bio or pixel-patrol-image) to integrate seamlessly.
