...
def test_defaults():
    ...
    assert config.filter_by is None
...
def test_to_dict_with_all_fields():
    ...
    assert d["filter_by"] == {"file_extension": {"op": "in", "value": "tif, png"}}
...
def test_from_dict_full():
    d = {
        "cmap": "plasma",
        "group_col": "size_readable",
        "filter_by": {"file_extension": {"op": "in", "value": "tif"}},
        "dimensions": {"C": "0"},
        "is_show_significance": True,
    }
    ...
    assert config.filter_by == {"file_extension": {"op": "in", "value": "tif"}}
...
def test_to_dict_from_dict_roundtrip():
    original = ReportConfig(
        ...
        filter_by={"file_extension": {"op": "eq", "value": "tif"}},
        dimensions={"Z": "2"},
        is_show_significance=True,
    )
    ...
    assert restored.filter_by == original.filter_by
