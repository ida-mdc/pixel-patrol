...
BASE_COLUMN_DESCRIPTIONS: Dict[str, str] = {
    ...
    "parent":              "Path of the containing directory, relative to the project base directory ('.' for files directly in the base directory); also split into one column per directory level (parent0, parent1, ...).",
