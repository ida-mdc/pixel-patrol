...
class ImageMosaikWidget(BaseReportWidget):
    ...
    def help_text(self) -> str:
        return (
            "The little pictures printed here are 2D representations of each file. "
            "They are generated by picking the center slice of all dimensions other than X and Y "
            "and scaling them into a square. It allows quick visual browsing of the dataset; "
