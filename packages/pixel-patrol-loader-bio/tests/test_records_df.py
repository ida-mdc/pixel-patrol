...
def test_build_records_df_from_file_system_with_images_returns_expected_columns_and_values(tmp_path, monkeypatch):
    ...
    def fake_build_deep_record_df(basic, loader_instance, processing_config=None, progress_callback=None, chunks_dir=None):
...
def test_build_records_df_from_file_system_merges_basic_and_deep_metadata_correctly(tmp_path, monkeypatch):
    ...
    def fake_build_deep_record_df(basic, loader, processing_config=None, progress_callback=None, chunks_dir=None):
