...
You can also **Save as CSV** to export a list of file paths (with all their metrics) that you can use to filter your image files for downstream processing — for example, deleting or excluding images whose `laplacian_variance` fell below a threshold.
