...
def main():
    ...
    # output path where the project parquet will be saved
    output_dir = Path("out")
    ...
    project = api.create_project("quickstart_simple", base_dir=base_path, loader=loader)
    ...
    api.process_files(project, processing_config=ProcessingConfig(output_dir=output_dir))
