...
if __name__ == "__main__":
    ...
    base_path = Path(__file__).resolve().parent.parent.parent / "data" / "geff"
    ...
    project = create_project("Local Test Image Collections", base_path, loader="geff")
    ...
    settings = Settings(
        ...
        cmap="viridis",
        n_example_files=5,
        pixel_patrol_flavor=".. but for GEFF!"
    )
